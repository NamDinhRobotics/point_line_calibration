...
int main(){
    ...
    points3D.emplace_back(1.0, 2.0, 0.1);
    points3D.emplace_back(2.0, -1.0, 0.1);
    points3D.emplace_back(3.0, 2.0, 0.1);
    points3D.emplace_back(2.5, -1.0, 0.1);
    points3D.emplace_back(1.5, -1.2, 0.1);
